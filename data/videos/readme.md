...
In the current public release, this directory may contain only a subset of the full dataset. The complete set of raw videos is available via controlled access for academic use.